...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 644.394050759520951, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 821.0, 657.845667113520221, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 665.845667113520221, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 565.69133422704067, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 669.583333333333485, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 481.69133422704067, 98.0, 22.0 ],
					"text" : "send launchWeb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 821.0, 687.131716979334215, 101.0, 102.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 606.845667113520108, 96.0, 31.0 ],
					"text" : "web client"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 693.631716979334215, 128.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 527.083333333333371, 105.0, 31.0 ],
					"text" : "web server"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 702.631716979334215, 136.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.5, 446.70641149847097, 192.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 653.5, 590.845667113520221, 466.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1034.0, 270.5, 56.0, 23.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1034.0, 222.0, 50.0, 22.0 ],
					"text" : "record~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.0, 254.0, 44.0, 22.0 ],
					"text" : "testing"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 476.0, 211.20641149847097, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 323.20641149847097, 119.0, 23.0 ],
					"text" : "prepend audioData"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 900.0, 270.5, 56.0, 22.0 ],
					"text" : "capture~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.0, 185.5, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 724.0, 159.199413359753009, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 258.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 705.5, 258.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 794.5, 185.5, 80.0, 22.0 ],
					"text" : "play~ sound0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 712.0, 112.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 285.0, 188.0, 20.0 ],
					"text" : "the identifier handler is looking for",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 284.0, 113.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.0, 163.699413359753009, 146.0, 28.0 ],
					"text" : "SEND",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 129.853205749235485, 245.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 453.0, 48.353205749235485, 97.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 56.20641149847097, 122.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 107.853205749235485, 257.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 311.5, 242.20641149847097, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 239.20641149847097, 74.0, 23.0 ],
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.0, 73.353205749235485, 120.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 211.20641149847097, 66.0, 23.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 73.353205749235485, 82.0, 22.0 ],
					"text" : "outputmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 372.0, 44.20641149847097, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 153.692415221035048, 299.0, 48.013996277435922 ],
					"style" : "texteditGold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 590.845667113520221, 146.0, 28.0 ],
					"text" : "RECIEVE",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 579.0, 218.0, 51.69133422704067 ],
					"style" : "default",
					"tabmode" : 0,
					"text" : "🔥"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 545.764731352422814, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 238.0, 466.4849227285697, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 522.631716979334215, 108.0, 24.0 ],
					"text" : "recieve a bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 286.0, 522.631716979334215, 24.0, 24.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 348.5, 102.20641149847097, 247.5, 102.20641149847097 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 302.5, 268.20641149847097, 232.0, 268.20641149847097, 232.0, 66.20641149847097, 247.5, 66.20641149847097 ],
					"order" : 1,
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 381.5, 101.70641149847097, 247.5, 101.70641149847097 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"name" : "max-client.js",
				"bootpath" : "~/Desktop/CART410/Websockets-in-Max-main/1_bang/max-client",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
